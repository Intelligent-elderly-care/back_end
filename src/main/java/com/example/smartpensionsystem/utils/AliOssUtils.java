...
public class AliOssUtils {
    ...
    //  EnvironmentVariableCredentialsProvider credentialsProvider = CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider();
     private static final String ACCESS_KEY_ID="LTAI5tNuEkafRpmZYKpbbddE";
    private static final String ACCESS_KEY_SECRET="vBzOfMfahJw9uYnjTAjL6M4ynactgv";
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKET_NAME = "hzy-event";
